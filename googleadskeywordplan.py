...
def main(client, customer_id):
    ...
    keyword_plan = _add_keyword_plan(client, customer_id)

    keyword_plan_resource_name = keyword_plan  # Not sure about this.

    keyword_plan_service = client.get_service("KeywordPlanService")
    print("got KeywordPlanService service")

    response_forcast = keyword_plan_service.generate_forecast_metrics(
        keyword_plan=keyword_plan_resource_name,
    )

    response_historical = keyword_plan_service.generate_historical_metrics(
        keyword_plan=keyword_plan_resource_name
    )

    for i, forecast in enumerate(response_forcast.keyword_forecasts):
    ...
    return response_historical, response_forcast


def _add_keyword_plan(client, customer_id):
    print("add keyword plan")
...
def _create_keyword_plan_ad_group_keywords(client, customer_id, plan_ad_group):
    print("create ad group keywords")
